...
Se você usa GitHub Pages, aguarde o deploy finalizar.`
  ...
  function adminView() {
    ...
    return viewShell(`
      ...
      <p class="p">Crie conteúdo sem programar. Exporte JSON pronto para colar no GitHub.</p>
      ...
      <div class="card">
        <div class="cardInner">
          <div class="chips" style="margin-top:0;">
            ...
            <button class="btn btnGlass btnSm" type="button" data-action="admin-tab" data-tab="export">Exportar JSON</button>
      ...
      <template id="tplAdminCreate">
        <div class="card hero">
          <div class="cardInner">
            ...
            <div class="small">Preencha, clique em <strong>Adicionar ao Meu Pacote</strong>. O item vai para o rascunho.</div>
            <div class="sep"></div>
      ...
      <template id="tplAdminExport">
        <div class="card hero">
          <div class="cardInner">
            <div class="h2" style="margin-top:0;">ABA 2 — Exportar JSON (pronto pra GitHub)</div>
            <div class="small">Escolha exportar somente o rascunho ou o pacote completo (conteúdo atual + rascunho).</div>
            <div class="sep"></div>

            <div class="row">
              <button class="btn btnGlass btnSm" type="button" data-action="admin-export-mode" data-mode="draft">Somente rascunho</button>
              <button class="btn btnGlass btnSm" type="button" data-action="admin-export-mode" data-mode="full">Pacote completo</button>
            ...
            <div class="notice">
              ...
              2) Vá no GitHub do projeto<br>
              3) Abra <code>packs/base/imports/content.json</code><br>
              4) Cole substituindo o arquivo inteiro e salve (Commit)<br>
              5) Recarregue o app
            </div>

            <div class="small" style="margin-top:10px;">
              Dica: “Salvar como conteúdo local” faz o app usar este JSON pelo localStorage (útil para testar offline).
            </div>
          </div>
        </div>
      </template>
      ...
      <template id="tplAdminImport">
        <div class="card hero">
          <div class="cardInner">
            <div class="h2" style="margin-top:0;">ABA 3 — Importar / Mesclar (sem apagar)</div>
            <div class="small">Cole um JSON (array de itens). O app valida, mescla e evita IDs duplicados automaticamente.</div>
            <div class="sep"></div>

            <textarea class="textarea" id="adImportArea" placeholder='Cole aqui um array JSON: [ { "id": "...", "type": "lesson", ... } ]'></textarea>
